...
export const education = [
  {
    ...
    description: [
      ...
      "Developed a deep understanding of computer science fundamentals, including data structures, algorithms, and software engineering.",
      "Completed a capstone project focused on developing a web application for managing student records, enhancing data organization and accessibility.",
    ],
  },
];
